...
class Config:
    ...
    CUSTOMER_JWT_EXPIRES_MINUTES = int(os.getenv('CUSTOMER_JWT_EXPIRES_MINUTES', '720'))
    CUSTOMER_COOKIE_NAME = os.getenv('CUSTOMER_COOKIE_NAME', 'mafalda_customer_session')
    CUSTOMER_COOKIE_SECURE = str_to_bool(os.getenv('CUSTOMER_COOKIE_SECURE'), default=False)
    CUSTOMER_COOKIE_SAMESITE = os.getenv('CUSTOMER_COOKIE_SAMESITE', 'Lax')
